            ...
            <div className="container">
                <div className="row p-2">
                    ...
                    <a style={{ border: '1px solid lightgrey', borderRadius: '5px', maxWidth: '400px' }} href="tel:09613823645" className='text-decoration-none text-white text-center mb-5 p-2 mx-auto d-block row'>
                        কোর্স সম্পর্কিত যেকোনো তথ্যের জন্য কল করুন <button className='btn-hero-call btn btn-dark btn-sm py-2 text-white fs-6'><img width={25} className='img-fluid' src='https://cdn.skillshikhun.com/images/call_white.svg' alt="call us" /> 09613823645</button></a>
