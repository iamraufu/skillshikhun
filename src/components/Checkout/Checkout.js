...
const Checkout = () => {
    ...
    useEffect(() => {
        if (code) {
            fetch('https://backend-skill-shikhun.herokuapp.com/getPromoCode/' + code)
                .then(res => res.json())
                .then(data => {
    ...
    const proceedToPayment = async () => {
        ...
        // SSL Payment Gateway
        // fetch('https://backend-skill-shikhun.herokuapp.com/ssl-request'
        // ,{
        //     method: 'POST',
        //     headers: { 
        ...
        // Aamar Pay Gateway
        // await fetch('https://backend-skill-shikhun.herokuapp.com/api/aamar-pay')
        //     .then(res => res.json())
        //     .then(data => {
    ...
    const verifyPromoCode = (code, course) => {
        fetch('https://backend-skill-shikhun.herokuapp.com/validatePromoCode', {
            method: 'POST',
