                            ...
                            return (
                                <div key={course.id} className='col-xl-3 col-md-6 col-md-3 my-5'>
                                    <div style={{ border: '1px solid #dde7f3',borderTopRightRadius: '15px', borderTopLeftRadius: '15px' }}>
                                        ...
                                        <div style={{height:'220px'}} className="bg-white py-4">
                                            <h2 style={{ fontSize: '20px', lineHeight: '30px', fontWeight: '600', color: '#354895' }} className='px-3'>{course.title}</h2>
                                        ...
                                        <h2 style={{ fontSize: '16px', lineHeight: '27px', fontWeight: '600', color: '#069654' }} className='pt-1 ps-3 price'>
                                                    <span style={{ color: '#354895' }}>মাত্র</span> ৳ {course.offer_price_per_month} 
