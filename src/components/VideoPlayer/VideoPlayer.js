            ...
            <nav style={{ backgroundColor: '#653dae' }} className="navbar navbar-expand-lg">
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse navbar-menu" id="navbarNavAltMarkup">
                        ...
                        {/* <h2 className='fs-6 text-white pt-2 cursor-pointer text-center ms-auto'>ভিডিও শেষ হয়েছে <span style={{ border: '2px solid #198754', borderRadius: '15px' }} className='ms-2 px-3 bg-white text-success fw-bold' >0/50</span></h2> */}

                        {/* <div className="d-flex justify-content-center align-items-center px-2">
                            <h2 className='fs-6 text-white cursor-pointer text-center pe-2 pt-2'>কোর্স কমপ্লিট হয়েছে 33%</h2>
                            <progress style={{ width: '100px' }} value='33' max="100" id="progressBar" className=''></progress>
                        </div> */}
