        ...
        <div>
            ...
            <div className="container-fluid">
                <div style={{ marginTop: '4rem' }} className="row my-5">
                    ...
                    {/* left sidebar */}
                    <div style={{ top: '0px' }} className="col-xl-2 col-md-3 d-none d-lg-block position-sticky">
                        <Sidebar />
                    </div>

                    {/* right container */}
                    <div style={{ minHeight: '800px', backgroundColor: '#f3f5f9', borderRadius: '15px' }} className="col-xl-8 col-md-8 py-5">
                        ...
                        <div className="row justify-content-center">
                            ...
                            <div style={{ borderRadius: '10px' }} className="col-md-5 bg-white mt-5 dashboard-content-card">
...

                                {
                                    liveCourses?.length > 0 ?
                                        ...
                                        <div className="ms-3">
                                            <p className='ms-3 text-danger text-center'>আপনি কোনো লাইভ কোর্সে ভর্তি হননি</p>
                                            <div className="">
                            ...
                            <div style={{ borderRadius: '10px' }} className="col-md-5 bg-white mt-4 dashboard-content-card">
                                <h2 style={{ fontSize: '24px', lineHeight: '36px', color: '#343b6d', fontWeight: '700', textAlign: 'center' }} className='mt-3'>
...

                                {
                                    videoCourses?.length > 0 ?
                                        ...
                                        <div className="ms-3">
                                            <p className='ms-3 text-danger text-center'>আপনি কোনো ভিডিও কোর্সে ভর্তি হননি</p>
                            ...
                            <div style={{ borderRadius: '10px' }} className="col-md-5 bg-white mt-4 dashboard-content-card">
...

                                {
                                    payments?.length > 0 ?
                                        ...
                                        <div className="ms-3">
                                            <p className='ms-3 text-danger text-center'> আপনার কোনো পেমেন্ট ইতিহাস নেই </p>
